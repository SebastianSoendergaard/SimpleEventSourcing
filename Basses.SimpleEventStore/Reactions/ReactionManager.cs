...
{
    public ReactionManager(IEventStore eventStore, IReactorStateStore reactorStateStore, ReactionsRegister reactionsRegister, IInstrumentation instrumentation, IServiceProvider serviceProvider)
        : base(eventStore, reactorStateStore, reactionsRegister, instrumentation, serviceProvider)
    {
    }
