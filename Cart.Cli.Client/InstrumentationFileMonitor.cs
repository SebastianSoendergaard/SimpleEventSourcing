...
internal static class InstrumentationFileMonitor
{
    public static async Task Run()
    {
        ...
        var headline = "StartTime;ProcessingTime (ms);Type;ItemCount;Details";
    ...
    private record Action(DateTimeOffset StartTime, string Type, JsonElement? StartDetails, JsonElement? CompleteDetails, TimeSpan ProcessingTime)
    {
        ...
        {
            return $"{StartTime:O};{ProcessingTime.TotalMilliseconds};{Type};{GetItemCount()};{CompleteDetails?.ToString()}";
        }
